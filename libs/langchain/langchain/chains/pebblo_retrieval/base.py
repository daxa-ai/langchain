...
from langchain.chains.pebblo_retrieval.enforcement_filters import (
    SUPPORTED_VECTORSTORES,
    set_enforcement_filters,
)
from langchain.chains.pebblo_retrieval.utilities import (
    get_runtime,
    APP_DISCOVER_URL,
    CLASSIFIER_URL,
    PROMPT_URL,
...
class PebbloRetrievalQA(Chain):
    ...
    def _call(
        ...
        print("docs: ", docs)
        print("run_manager: ", run_manager.__dict__)
        qa = {
            "name": self.app_name,
            "context": [
                {
            ...
            "user": auth_context.username if auth_context else "unknown",
        }
        qa_payload = Qa(**qa)
    ...
    def from_chain_type(
        ...
        **kwargs: Any,
        ...
        app = PebbloRetrievalQA._get_app_details(
            app_name=app_name, description=description, owner=owner,
            llm=llm, **kwargs,
        )
    ...
    @staticmethod
    def _get_app_details(app_name, owner, description, llm, **kwargs) -> App:
    ...
    @staticmethod
    def _send_discover(app, api_key) -> None:
        ...
        try:
            ...
            print("discover-payload", payload)
            logger.debug(
                ...
                "vector_dbs": [
                    {
                        ...
                        "embedding_model": kwargs['retriever'].vectorstore._embeddings.model
                    }
                ]
                }
            ]
